...
public class StepView extends View {
    ...
    private void applyStyles(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        unSelectedTextColor = ta.getColor(R.styleable.StepView_sv_unSelectedTextColor, 0);
    ...
    private int measureStepsHeight() {
        ...
        for (int i = 0; i < steps.size(); i++) {
            ...
            Layout.Alignment alignment =
                    isRtl() ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_OPPOSITE;
    ...
    public class State {
        ...
        @ColorInt
        private int unSelectedCircleColor = StepView.this.unSelectedCircleColor;
        @Dimension
        private int selectedCircleRadius = StepView.this.selectedCircleRadius;
        @Dimension
        private int unSelectedCircleRadius = StepView.this.unSelectedCircleRadius;
        @ColorInt
        private int selectedTextColor = StepView.this.selectedTextColor;
        @ColorInt
        private int unSelectedTextColor = StepView.this.unSelectedTextColor;
        @ColorInt
        ...
        public void commit() {
            ...
            StepView.this.unSelectedCircleRadius = unSelectedCircleRadius;
            StepView.this.unSelectedCircleColor = unSelectedCircleColor;
            StepView.this.selectedCircleColor = selectedCircleColor;
            StepView.this.selectedTextColor = selectedTextColor;
            StepView.this.unSelectedTextColor = unSelectedTextColor;
