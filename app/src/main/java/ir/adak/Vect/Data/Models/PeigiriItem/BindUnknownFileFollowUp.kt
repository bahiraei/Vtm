...
//                            .into(viewHolder.itemView.img_avatar_my_file)
//                    }

                    if (followUp.isReply) {
                        viewHolder.itemView.constraint_my_file_reply_layout.visibility =
                            View.VISIBLE
                        viewHolder.itemView.txt_my_file_reply_username.text =
                        ...
                        when (followUp.replyFollowUp?.followUpType) {
                            FollowUpType.Text -> {
                                ...
                                if (followUp.replyFollowUp?.followUpType == FollowUpType.Text) {
                                    viewHolder.itemView.txt_my_file_reply_text.text =
                            ...
                            FollowUpType.File -> {
                                when (followUp.replyFollowUp?.fileTypeEnum) {
                                    FileTypeEnum.Unknown -> {
                                        ...
                                        viewHolder.itemView.img_my_file_reply_thumbnail.visibility =
                                            View.GONE
                                    }
                                    ...
                                    -> {
                                        ...
                                        if (followUp.replyFollowUp?.file?.exists() == true) {
                                            ...
                                            Glide.with(viewHolder.itemView.context)
                                                .load(uri)
                                                .centerCrop()
                                                .into(viewHolder.itemView.img_my_file_reply_thumbnail)
                                        } else {
                                            Glide.with(viewHolder.itemView.context)
                        ...
                        viewHolder.itemView.constraint_my_file_reply_layout.setOnClickListener {
                    ...
                    viewHolder.itemView.txt_username_my_file.text = followUp.createName
                    viewHolder.itemView.txt_semat_my_file.text = followUp.orgLevelTitle
                    viewHolder.itemView.txt_date_my_file.text = followUp.persianDate
                    viewHolder.itemView.txt_file_name_my_file.text = followUp.fileNameForShow
                    viewHolder.itemView.txt_file_size_my_file.text =
                        followUp.fileSizeLabel
                    viewHolder.itemView.circularProgressBar_my_file.progressMax = 100f
                    viewHolder.itemView.txt_file_extension_my_file.text =
                ...
                false -> {
                    if (followUp.isFixedHighLight){
                        viewHolder.itemView.img_highlight_others_file.alpha = 1f
                    }else{
...
//                        Glide.with(viewHolder.itemView.context)
//                            .load(Constants.AVATAR_BASE_URL + followUp.profileImage)
//                            .into(viewHolder.itemView.img_avatar_others_file)
//                    }

                    if (followUp.isReply) {
                        viewHolder.itemView.constraint_others_file_reply_layout.visibility =
                            View.VISIBLE
                        viewHolder.itemView.txt_others_file_reply_username.text =
                            followUp.replyFollowUp?.createName
                        ...
                        when (followUp.replyFollowUp?.followUpType) {
                            FollowUpType.Text -> {
                                ...
                                if (followUp.replyFollowUp?.followUpType == FollowUpType.Text) {
                                    viewHolder.itemView.txt_others_file_reply_text.text =
                                        followUp.replyFollowUp?.description
                                }
                            }
                            FollowUpType.File -> {
                                when (followUp.replyFollowUp?.fileTypeEnum) {
                                    FileTypeEnum.Unknown -> {
                                        ...
                                        viewHolder.itemView.txt_others_file_reply_text.text =
                                            "فایل  ${followUp.replyFollowUp?.fileExtension}"
                                        viewHolder.itemView.img_others_file_reply_thumbnail.visibility =
                                            View.GONE
                                    }
                                    FileTypeEnum.FaceStatus -> {
                        ...
                        viewHolder.itemView.constraint_others_file_reply_layout.setOnClickListener {
                            onReplyFollowUpClicked?.OnReplyFollowUpClicked(followUp.replyFollowUp)
                        }
                    } else {
                        viewHolder.itemView.constraint_others_file_reply_layout.visibility =
                    ...
                    viewHolder.itemView.txt_username_others_file.text =
                        followUp.createName
                    viewHolder.itemView.txt_semat_others_file.text =
                        followUp.orgLevelTitle
                    viewHolder.itemView.txt_date_others_file.text = followUp.persianDate
                    viewHolder.itemView.txt_file_name_others_file.text =
                        followUp.fileNameForShow
                    viewHolder.itemView.txt_file_size_others_file.text =
                        followUp.fileSizeLabel
                    viewHolder.itemView.circularProgressBar_others_file.progressMax =
                        100f
                    viewHolder.itemView.txt_file_extension_others_file.text =
                        followUp.fileExtension
